...
The boundary layer solver is validated through comparison with the exact Blasius solution, valid for laminar flow. Until natural transition, which occurs at $\text{x/L} = 0.38$, the calculated $\theta$ value matches closes with Blasius.
