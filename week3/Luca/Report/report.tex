...
The lift coefficient is calculated from the circulation via $C_L = -2\frac{\Gamma}{Uc}$, which is entirely based on inviscid potential flow theory. It is therefore unsurprising that neither $C_L-\alpha$ curves show no stall characteristics - they receive no feedback from the boundary layer calculations.
