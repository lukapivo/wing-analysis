...
\subsection{LLH01}
Decrease upper surface curvature near nose to reduce suction peak; mostly successful.

Gets 145.6 at 6.8
\subsection{LLH02}
A 80\% of the boundary layer growth is in the final 10\% of the airfoil. There's basically no amount of lift that can be coming from here to warrant the adverse pressure gradient.
