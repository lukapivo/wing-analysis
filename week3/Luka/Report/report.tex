...
So as not to bias towards an existing laminar design as starting with a 6- or 7-series airfoil would, the NACA 0012 was the starting point, with a maximum $L/D$ is 58.826 at \qty{7.6}{\degree} at $C_L = 0.9145$.
\begin{figure}[H]
    \centering
    \begin{minipage}{0.49\textwidth}
        \centering
