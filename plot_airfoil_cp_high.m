...
caseref = "Data/final_LLH01_5.mat";
load(caseref);
...
caseref = "Data/final_LLH02_5.mat";
load(caseref);
...
caseref = "Data/final_LLH03_5.mat";
load(caseref);
...
caseref = "Data/final_LLH04_5.mat";
load(caseref);
...
% 
% 
caseref = "Data/LLL08b6_high_5.mat";
load(caseref);
...
legend('LLL08', 'Location','northeast')
set(gcf,'units', 'centimeters','position',[0,0,8,5])
saveas(gcf,'week3/Figures/cp_final_LLH01_7.8.eps','epsc2')
